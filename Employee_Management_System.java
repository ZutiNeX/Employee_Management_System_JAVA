...
static class Employee_Show{
        public void vieFile(String s) throws Exception{
    ...
    public void viewFile(String i) {
    }
}

static class Employee_Remove{
...
static class CodeExit{
            public void out(){
                System.out.println("\n*****************************************");
                System.out.println("$ cat Thank You For Using my Software :) ");
                System.out.println("*****************************************");
                System.out.println("\t\t/~ <0d3d by ZutiNeX\n");
                System.exit(0);
            }
      }
  }
...
public class bigproj {
    public static void main(String[] args) {
        System.out.print("\033[H\033[2J");

        Scanner sc = new Scanner(System.in);
        MainMenu.Employee_Show epv = new MainMenu.Employee_Show();
        ...
        while (i < 6) {
            ...
            switch (i) {
                case 1: {
                    MainMenu.Employee_Add ep = new MainMenu.Employee_Add();
                    ep.createFile();
                ...
                case 3: {
                    System.out.println("\nPlease enter employee's id: ");
                    String s = sc.nextLine();
                    MainMenu.Employee_Remove epr = new MainMenu.Employee_Remove();
                    epr.removeFile(s);
                ...
                case 4:
                {
                    ...
                    MainMenu.Employee_Remove.Employee_Update epu = new MainMenu.Employee_Remove.Employee_Update();
                ...
                case 5:
                {
                    MainMenu.Employee_Remove.CodeExit obj = new MainMenu.Employee_Remove.CodeExit();
                    obj.out();
                }
            }
        }
